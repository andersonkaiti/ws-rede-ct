...
> {
  ...
  /**
   * `prisma.financialTransactionStatement`: Exposes CRUD operations for the **FinancialTransactionStatement** model.
   * Example usage:
   * ```ts
   * // Fetch zero or more FinancialTransactionStatements
   * const financialTransactionStatements = await prisma.financialTransactionStatement.findMany()
   * ```
   */
  get financialTransactionStatement(): Prisma.FinancialTransactionStatementDelegate<
    ExtArgs,
    { omit: OmitOpts }
  >

  /**
   * `prisma.checkingAccount`: Exposes CRUD operations for the **CheckingAccount** model.
   * Example usage:
   * ```ts
   * // Fetch zero or more CheckingAccounts
   * const checkingAccounts = await prisma.checkingAccount.findMany()
   * ```
   */
  get checkingAccount(): Prisma.CheckingAccountDelegate<
    ExtArgs,
    { omit: OmitOpts }
  >
}
