import { DeleteCertificationController } from '../../controllers/certifications/delete-certification-controller.ts'
...
import { UpdateCertificationController } from '../../controllers/certifications/update-certification-controller.ts'
...
export function makeUpdateCertificationController() {
  return {
...
export function makeDeleteCertificationController() {
  return {
