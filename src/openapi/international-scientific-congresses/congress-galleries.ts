...
import z from 'zod'
import { createInternationalScientificCongressGallerySchema } from '../../controllers/international-scientific-congress-gallery/create-international-scientific-congress-gallery-controller.ts'
import { deleteInternationalScientificCongressGallerySchema } from '../../controllers/international-scientific-congress-gallery/delete-international-scientific-congress-gallery-controller.ts'
import { findInternationalScientificCongressGalleriesByCongressIdSchema } from '../../controllers/international-scientific-congress-gallery/find-international-scientific-congress-galleries-by-congress-id-controller.ts'
import { updateInternationalScientificCongressGallerySchema } from '../../controllers/international-scientific-congress-gallery/update-international-scientific-congress-gallery-controller.ts'
...
export const createCongressGalleryRegistry: RouteConfig = {
  ...
  request: {
    ...
    body: {
      content: {
        'application/json': {
          schema: createInternationalScientificCongressGallerySchema.omit({
            congressId: true,
          }),
        },
      },
...
export const findCongressGalleriesByCongressIdRegistry: RouteConfig = {
  ...
  request: {
    params: findInternationalScientificCongressGalleriesByCongressIdSchema,
  },
  responses: {
    200: {
      description:
...
export const updateCongressGalleryRegistry: RouteConfig = {
  ...
  security: [{ bearerAuth: [] }],
  request: {
    params: deleteInternationalScientificCongressGallerySchema,
    body: {
      content: {
        'application/json': {
          schema: updateInternationalScientificCongressGallerySchema.omit({
            id: true,
          }),
        },
      },
